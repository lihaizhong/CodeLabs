...
export type PlatformOffscreenCanvas = MiniProgramOffscreenCanvas | OffscreenCanvas;
...
export type Bitmap = PlatformImage | ImageBitmap | HTMLCanvasElement | OffscreenCanvas;

(function(g,f){typeof exports==='object'&&typeof module!=='undefined'?f(exports):typeof define==='function'&&define.amd?define(['exports'],f):(g=typeof globalThis!=='undefined'?globalThis:g||self,f(g.OctopusPlatform={}));})(this,(function(exports){'use strict';var noop = (function () { });/******************************************************************************
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, new Promise(function (resolve) { return setTimeout(resolve, intervals[times]); })];
                case 5:
                    _a.sent();
                    times++;
                    return [3 /*break*/, 6];
...
function decodeUTF8Sequence(buffer, pos, end) {
    ...
    return { codePoint: codePoint, nextPos: nextPos };
}
/**
 * 将码点追加到缓冲区，必要时提交
...
function decodeMixedContent(buffer, start, end) {
    ...
    while (i < end) {
        ...
        // 解码 UTF-8 多字节序列
        var _a = decodeUTF8Sequence(buffer, i - 1, end), codePoint = _a.codePoint, nextPos = _a.nextPos;
        i = nextPos;
...
function utf8(buffer, start, end) {
    ...
    OctopusPlatform.prototype.autoEnv = function () {
        var envs = [
            { name: 'h5', check: function () { return typeof window !== 'undefined'; } },
            { name: 'tt', check: function () { return typeof tt !== 'undefined'; } },
            { name: 'alipay', check: function () { return typeof my !== 'undefined'; } },
            { name: 'weapp', check: function () { return typeof wx !== 'undefined'; } },
            { name: 'harmony', check: function () { return typeof has !== 'undefined'; } },
        ];
        ...
        throw new Error("Unsupported platform! Available: ".concat(envs.map(function (e) { return e.name; }).join(', ')));
    };
 ...
 * 定义平台插件
 */
var definePlugin = function (plugin) { return plugin; };function installPlugin(self, plugin) {
...
function createPlatform(plugins, version) {
    ...
    var InternalPlatform = /** @class */ (function (_super) {
        __extends(InternalPlatform, _super);
        function InternalPlatform() {
            var _this = _super.call(this, plugins, version) || this;
            _this.init(); // 在基类中调用 init
            return _this;
        }
        InternalPlatform.prototype.installPlugin = function (plugin) {

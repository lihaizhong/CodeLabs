...
exports.SourcemapLocatorAPI = void 0;
...
tslib_1.__exportStar(require("./recursive-locator"), exports);
const recursive_locator_1 = require("./recursive-locator");
...
class SourcemapLocatorAPI {
     ...
     */
    constructor(config) {
        this.locator = new recursive_locator_1.RecursiveLocator(config);

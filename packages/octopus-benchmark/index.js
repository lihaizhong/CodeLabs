(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('octopus-platform')) :
    typeof define === 'function' && define.amd ? define(['octopus-platform'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.benchmark = factory(global.octopusPlatform));
})(this, (function (octopusPlatform) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var EnhancedPlatform = /** @class */ (function (_super) {
        ...
        function EnhancedPlatform() {
            var _this = _super.call(this, [octopusPlatform.pluginNow, octopusPlatform.pluginSystem], version) || this;
            _this.init();
            return _this;
        }
    ...
    var Stopwatch = /** @class */ (function () {
        function Stopwatch() {
            this.isRealMachine = ["ios", "android", "openharmony"].includes(platform.system);
        ...
        Stopwatch.prototype.stop = function (label) {
            if (this.isRealMachine) {
                ...
                if (this.timeLabels.has(label)) {
                    console.log("".concat(label, ": ").concat(nowTime - this.timeLabels.get(label), " ms"));
        ...
        Stopwatch.prototype.mark = function (label) {
            ...
            if (this.markLabels.has(label)) {
                console.log("".concat(label, ": ").concat(nowTime - this.markLabels.get(label), " ms"));
            }
